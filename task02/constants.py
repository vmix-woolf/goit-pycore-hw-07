...
DIGITS_ERROR = f"Phone should consist of exactly {DIGITS_IN_PHONE_NUMBER} digits!"
...
CONTACT_IS_IN_BOOK = "Contact is already in the address book."
...
NECESSARY_TO_CONGRATULATE = "\tThere are no letters scheduled to be mailed in the next week."
TITLE_TO_CONGRATULE = "It's neccessay to congratulate the following contacts"